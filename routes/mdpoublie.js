...
var mail = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'stagepfe@gmail.com', // Your idr email
        pass: 'A12345678.' // Your password
    }
    });
    var mailOptions = {
     from: 'uvct',
    ...
    html: '<p>You requested for reset password, kindly use this <a href="http://localhost:5000/mdpoublie?token=' + token 
